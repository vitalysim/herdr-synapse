...
class PickerWizardTests(unittest.TestCase):
    ...
    def test_validation_and_backtracking(self):
        ...
        picker_apply_key(model, "ENTER")
        self.assertEqual(model.stage, "target")  # a team exists: add to it, or create a new one
        ...
        picker_apply_key(model, "ENTER")
        # an existing team's name is the add choice of the target stage, not a refusal; Esc returns there
