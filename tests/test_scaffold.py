...
class ManifestTests(unittest.TestCase):
    def test_manifest_is_regular_file_with_expected_entries(self):
        ...
        self.assertEqual(action_ids, ["team-up", "compose", "console", "who", "toggle-view", "daemon-start"])
        pane_ids = re.findall(r'^\[\[panes\]\]\nid = "([^"]+)"', text, re.M)
        self.assertEqual(pane_ids, ["console", "compose", "picker"])
    ...
    def test_manifest_parses_as_toml(self):
        ...
        self.assertEqual([a["contexts"] for a in doc["actions"]], [["global"], ["pane"], ["global"], ["global"], ["global"], ["global"]])
